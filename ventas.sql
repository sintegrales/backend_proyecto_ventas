...
--
-- Servidor: localhost
-- Tiempo de generación: 25-02-2024 a las 15:45:08
...
INSERT INTO `ciudad` (`id_ciudad`, `nombre`, `estado`, `fo_dpto`) VALUES
(1, 'Abriaquí', 1, 5),
(2, 'Acacías', 1, 50),
(3, 'Acandí', 1, 27),
(4, 'Acevedo', 1, 41),
...
INSERT INTO `cliente` (`id_cliente`, `ident`, `nombre`, `direccion`, `celular`, `email`, `fo_ciudad`) VALUES
(1, '10101010', 'PEDRO PEREZ', 'SDFDSFS', '23212321', 'pedro@gmail.com', 19),
(2, '20202020', 'SARA POLILLA', 'DFGDFGF', '312312345', 'sara@hotmail.com', 10);
...
INSERT INTO `prodcuto` (`id_producto`, `codigo`, `nombre`, `fo_categoria`, `precio_compra`, `precio_venta`, `stock`, `fo_proveedor`) VALUES
(1, '001', 'Coca cola 1.5 lts', 1, 4500, 5500, 30, 2),
(2, '002', 'Choiriozos asados', 2, 10000, 12000, 10, 1),
(3, '003', 'Manzana Postobon 1.5 lts', 1, 4500, 5500, 30, 1),
(4, '004', 'Arepa Burguer', 2, 5000, 8000, 20, 2),
(9, '005', 'Jugo HIT', 1, 2000, 3000, 20, 2);
...
INSERT INTO `proveedor` (`id_prov`, `ident`, `nombre`, `direccion`, `celular`, `email`, `fo_ciudad`) VALUES
(1, '1234567', 'Proveedor 1', 'xxxxxx', '321456988', 'prov@gmail.com', 19),
(2, '12345678', 'Proveedor 2', 'xxxxxx', '321654658', 'prov2@gmail.com', 20);
...
INSERT INTO `usuario` (`id_usuario`, `ident`, `nombre`, `direccion`, `celular`, `email`, `rol`, `clave`) VALUES
(1, '10030071', 'Andrés Felipe Parra Martínez', 'Mz 6 casa 2 Los Olivos ', '3217944975', 'sintegralesei@gmail.com', 'Administrador', '7c4a8d09ca3762af61e59520943dc26494f8941b'),
(2, '1', 'Invitado', '**', '**', 'invitado@gmail.com', 'Invitado', '7c4a8d09ca3762af61e59520943dc26494f8941b');
...
INSERT INTO `ventas` (`id_venta`, `fecha`, `fo_cliente`, `productos`, `subtotal`, `total`, `fo_vendedor`) VALUES
(1, '2024-02-18', 1, 'asdad', 45645, 789789, 1),
(11, '2024-02-18', 2, 'a:2:{i:0;a:5:{i:0;s:3:\"004\";i:1;s:13:\"Arepa Burguer\";i:2;i:8000;i:3;i:2;i:4;i:16000;}i:1;a:5:{i:0;s:3:\"003\";i:1;s:24:\"Manzana Postobon 1.5 lts\";i:2;i:5500;i:3;i:2;i:4;i:11000;}}', 27000, 27000, 1),
(12, '2024-02-18', 1, 'a:2:{i:0;a:5:{i:0;s:3:\"002\";i:1;s:17:\"Choiriozos asados\";i:2;i:12000;i:3;i:2;i:4;i:24000;}i:1;a:5:{i:0;s:3:\"005\";i:1;s:8:\"Jugo HIT\";i:2;i:3000;i:3;i:2;i:4;i:6000;}}', 30000, 30000, 1),
(13, '2024-02-25', 2, 'a:1:{i:0;a:5:{i:0;s:3:\"001\";i:1;s:17:\"Coca cola 1.5 lts\";i:2;i:5500;i:3;i:2;i:4;i:11000;}}', 11000, 11000, 1),
(14, '2024-02-25', 1, 'a:4:{i:0;a:5:{i:0;s:3:\"001\";i:1;s:17:\"Coca cola 1.5 lts\";i:2;i:5500;i:3;i:2;i:4;i:11000;}i:1;a:5:{i:0;s:3:\"004\";i:1;s:13:\"Arepa Burguer\";i:2;i:8000;i:3;i:0;i:4;i:0;}i:2;a:5:{i:0;s:3:\"002\";i:1;s:17:\"Choiriozos asados\";i:2;i:12000;i:3;i:2;i:4;i:24000;}i:3;a:5:{i:0;s:3:\"005\";i:1;s:8:\"Jugo HIT\";i:2;i:3000;i:3;i:1;i:4;i:3000;}}', 38000, 38000, 1),
(15, '2024-02-25', 1, 'a:1:{i:0;a:5:{i:0;s:3:\"004\";i:1;s:13:\"Arepa Burguer\";i:2;i:8000;i:3;i:2;i:4;i:16000;}}', 16000, 16000, 1),
(16, '2024-02-25', 2, 'a:1:{i:0;a:5:{i:0;s:3:\"002\";i:1;s:17:\"Choiriozos asados\";i:2;i:12000;i:3;i:2;i:4;i:24000;}}', 24000, 24000, 1);
...
--
ALTER TABLE `ciudad`
  MODIFY `id_ciudad` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1101;
...
--
ALTER TABLE `dpto`
  MODIFY `id_dpto` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;

--
-- AUTO_INCREMENT de la tabla `prodcuto`
--
ALTER TABLE `prodcuto`
...
--
ALTER TABLE `compras`
  ADD CONSTRAINT `compras_ibfk_1` FOREIGN KEY (`fo_proveedor`) REFERENCES `proveedor` (`id_prov`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `compras_ibfk_2` FOREIGN KEY (`fo_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `prodcuto`
--
ALTER TABLE `prodcuto`
  ADD CONSTRAINT `prodcuto_ibfk_1` FOREIGN KEY (`fo_proveedor`) REFERENCES `proveedor` (`id_prov`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `prodcuto_ibfk_2` FOREIGN KEY (`fo_categoria`) REFERENCES `categoria` (`id_categoria`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
--
ALTER TABLE `ventas`
  ADD CONSTRAINT `ventas_ibfk_1` FOREIGN KEY (`fo_cliente`) REFERENCES `cliente` (`id_cliente`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `ventas_ibfk_2` FOREIGN KEY (`fo_vendedor`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
